...
<head>
  <meta charset="UTF-8">
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta property="og:title" content=anbuinfosec | Home>
  <meta property="og:type" content="website">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta http-equiv="X-UA-Compatible" content="ie=edge">
  <title>Mohammad Alamin | anbuinfosec</title>
  <meta name="description" content="">
  <meta name="keywords" content="anbuinfosec">
  <meta name="author" content="Mohammad Alamin">
...
<body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://source.unsplash.com/1L71sPT5XKc');">
  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div class="w-full lg:w-2/5">
		<img src="https://avatars.githubusercontent.com/u/135030867?v=4" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
	</div>
